...
# Feature levels
FEATURE_LEVELS = x86-64-v1 x86-64-v2 x86-64-v3
...
build-iso: pacman-conf
	...
	@mkarchiso -v -w /tmp/mkarchiso -o baseline/out baseline -quiet=y
	@mv baseline/out/*.iso /tmp/MCSHOS-$(K8S_VERSION)-$(FEATURE_LEVEL).iso
	@rm -rf /tmp/mkarchiso/*
